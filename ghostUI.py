...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(10, 10, 175, 308)) # increase last param by 23 for each new checkbox
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "Ghost Master MiniEditor v0.2.6", None))
